...
# 1人100回の回答を100名分, y=回答(正、誤)、sは被験者ID、theta値に基づいて、成功数から0,1データに変換
...
saveGraph( file=paste0("Jags-Ydich-XnomSsubj-MbinomBetaOmegaKappa-Power-",
                       idealNsubj,"-",idealNtrlPerSubj) , type="png" )
...
nSimulatedDataSets = min(10,NROW(mcmcMat)) # An arbitrary large number.
